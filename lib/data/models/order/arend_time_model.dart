class ArendStartTimeModel {
  ...
  ArendStartTimeModel.fromJson(Map<String, dynamic> json)
...
class ArendEndTimeModel {
  ...
  ArendEndTimeModel.fromJson(Map<String, dynamic> json)
      : ticks = json['ticks'] as int?,
        days = json['days'] as int?,
        hours = json['hours'] as int?,
        milliseconds = json['milliseconds'] as int?,
