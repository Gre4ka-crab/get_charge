...
import 'package:get_charge/presentation/widget/PhoneInfo.dart';
...
class DrawerMenu {
  static final List<MenuItem> defaultItemsList = [
    MenuItem(
        ...
        routName: '/userProfile',
        assetName: 'images/person.svg'),
    MenuItem(
        title: Row(
          children: [
            const Text('Бонусы'),
            Padding(
              ...
              child: Container(
                padding:
                    const EdgeInsets.only(top: 5, left: 8, right: 6, bottom: 4),
    ...
    MenuItem(
        title: const Text('Поддержка'), assetName: 'images/headsetAndMic.svg'),
    MenuItem(
        title: const Text('Как это работает'), assetName: 'images/book.svg'),
    MenuItem(
        title: const Text('О приложении'),
        routName: '/aboutApplication',
        assetName: 'images/phoneMenu.svg'),
    MenuItem(
                        ...
                        child.add(ListTile(
                          leading: Padding(
                            padding: EdgeInsets.only(
                                right: menuItem.leadingRightPudding ?? 23),
