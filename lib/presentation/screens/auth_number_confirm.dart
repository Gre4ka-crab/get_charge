        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: const [
                      Text(
                        '+7 (904) 000 ХХ ХХ',
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color.fromARGB(255, 39, 39, 39)),
                      ),
                      Text('Входящий звонок', style: TextStyle(fontSize: 11, color: Color.fromARGB(255, 134, 135, 137))),
                    ],
                  ),
                ],
              ),
            ...
            Pinput(
              ...
              validator: (s) {
                return s == '2222' ? null : 'Неверный код. Пожалуйста, попробуйте еще раз';
              },
              autofocus: true,
