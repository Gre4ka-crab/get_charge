  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: BlocConsumer<ProfileCubit, ProfileState>(listener: (BuildContext context, state) {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(child: LineButton(callback: () {}, buttonLabel: 'Выйти', borderRadius: const Radius.circular(15)))
                  ],
                )
              ],
            );
